...
def sinapi_title_identifier(string):
    sinapis_location = string.find('inapis')
    print(sinapis_location)
    wanted_title = string[sinapis_location+16:]
    print(wanted_title)

test = 'Sinapis_SOAP_GL1_AT3G27920'
sinapi_title_identifier(test)
...
BO_TEST = 'Bo1g020110.1 cds chromosome:BOL:C3:64582384:64583577:1 gene:Bo1g020110 gene_biotype:protein_coding transcript_biotype:protein_coding'
BRAPA_TEST = 'Bra013364.1 cdna chromosome:Brapa_1.0:A08:350979:352142:-1 gene:Bra013364 gene_biotype:protein_coding transcript_biotype:protein_coding description:AT1G55460 (E=1e-091) | Kin17 DNA-binding protein-related'
ref_id_list = []
match_id_list = []
...
'''Now you have lots of blast summary files for the trichome genes, pass it through the'''