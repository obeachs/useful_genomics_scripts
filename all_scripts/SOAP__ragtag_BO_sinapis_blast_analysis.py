...
blast_file_folder_SOAP_read_corrected = '/Volumes/seagatedrive/Project_folder/sinapis_assembly_shenanigans/new_SOAP_sinapis_GSS_blast/'

directory = '/Volumes/seagatedrive/Project_folder/sinapis_assembly_shenanigans/blast_script_runs/SOAP_GSS_reads/'

blast_file_list = []
for f in listdir(blast_file_folder_SOAP_read_corrected):
    blast_file_list.append(blast_file_folder_SOAP_read_corrected + f)
