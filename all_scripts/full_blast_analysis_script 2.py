...
parser.add_argument('--queryIDS', required = True, default = None, type = str)
...
'''Function that references the cdna file 
 the list of ids and generate a new
...
def auto_blast(queryfile, database, outname):
    blast_command = ['blastp', '-query', queryfile, '-db',  database, '-out', outname, '-max_target_seqs','20', '-num_threads', '8', '-evalue', '1e-2', '-outfmt', '5']
