...
'''This is a useful script to merge/concatenate blastXML output files, just add the files (can be as many as possible) you want to merge together
after you give the name of the output'''
import sys
